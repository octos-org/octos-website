...
const nodes = [
  {
    ...
    type: 'step',
    position: { x: 620, y: 0 },
    data: { label: 'MASTER', description: 'Owns the goal and the turn', bg: '#6B21A8', border: '#9333EA' },
  ...
  },
  {
    ...
    type: 'step',
    position: { x: 0, y: 170 },
    data: { label: 'SUB-AGENT', description: 'delegate \u00B7 blocking, depth \u2264 2', bg: '#00B4EF', border: '#0090C0' },
    sourcePosition: Position.Bottom,
  ...
  },
  {
    ...
    data: { label: 'PEER', description: 'own session \u00B7 own worktree', bg: '#00B4EF', border: '#0090C0' },
    sourcePosition: Position.Bottom,
    targetPosition: Position.Top,
  },
  {
    ...
    data: { label: 'PEER', description: 'numbered instruction rounds', bg: '#00B4EF', border: '#0090C0' },
    sourcePosition: Position.Bottom,
    targetPosition: Position.Top,
  },
  {
    ...
    data: { label: 'FLEET WORKER', description: 'closed registry \u00B7 granted scope', bg: '#00B4EF', border: '#0090C0' },
    sourcePosition: Position.Bottom,
    targetPosition: Position.Top,
  },
  {
    ...
    data: { label: 'MONITOR', description: 'zero-token watcher', bg: '#00B4EF', border: '#0090C0' },
    sourcePosition: Position.Bottom,
    targetPosition: Position.Top,
  },
  {
    ...
    data: { label: 'GATHER', description: 'Blackboard fan-in \u00B7 verifier lane', bg: '#0090C0', border: '#006890' },
    sourcePosition: Position.Bottom,
    targetPosition: Position.Top,
  },
  {
    ...
    data: { label: 'RESULT', description: 'Settled in the goal ledger', bg: '#FF5F1F', border: '#D15010' },
    targetPosition: Position.Top,
  },
];
